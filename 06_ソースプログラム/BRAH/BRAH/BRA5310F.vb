...
''' </summary>
''' <remarks></remarks>
Public Class BRA5310F

    Private Sub BRA5310F_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ' REV_001↓
            'バージョン区分コンボボックス設定
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Dim xlForm As BRA5320X = Nothing
        ...
        Try
            ...
            ' REV_001↓
            'xlForm = New BRA5320X(Me, einouKeieitai)
            xlForm = New BRA5320X(Me, cboVerKubun.SelectedValue.ToString, einouKeieitai)
            ' REV_001↑
    ...
    Private Sub btnImport_Click(sender As Object, e As EventArgs) Handles btnImport.Click
        Try
            ...
            '集計結果表作成論理取込クラス生成
            ' REV_001↓
            'Using ExcelImport = New ImportSyukeiKekkahyoSakuseiRonri(einouKeieitai)
            Using ExcelImport = New ImportSyukeiKekkahyoSakuseiRonri(einouKeieitai, cboVerKubun.SelectedValue.ToString)
                ' REV_001↑
                '処理実行
    ...
    Private Sub btnOutPut_Click(sender As Object, e As EventArgs) Handles btnOutPut.Click
        Try
            Dim fileName As String = ComConst.集計結果表作成論理.出力用ファイル名称.reportName & "_" _
            ...
            Try
                ...
                ' REV_001↓
                'Using ExcelOutput = New BRA5310R(filePath, einouKeieitai)
                Using ExcelOutput = New BRA5310R(filePath, cboVerKubun.SelectedValue.ToString, einouKeieitai)
                    ' REV_001↑
    ...
    Public Sub UpdateDate(txt As TextBox, einouKeieitai As String, cbo As ComboBox)
        ...
        Using db As New DBAccess(ComUtil.GetCurrentConnectionString(CommonInfo.Koutei))
            ' REV_001↓
            'dtn = DAOOther.GetSyukeiKekkahyoSakuseiRonriUpdateDate(db, chosakubun)
            dtn = DAOOther.GetSyukeiKekkahyoSakuseiRonriUpdateDate(db, chosakubun, cbo.SelectedValue.ToString)
            ' REV_001↑
        End Using
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Class ImportSyukeiKekkahyoSakuseiRonri
        ...
        Public Sub New(einouKeieitai As String, versionKbn As String)
            ' REV_001↑
            MyBase.New(True)
        ...
        Private Function CheckFileFormat(xlSheets As Excel.Sheets) As Boolean
            ...
            Try
                ...
                For Each wsh As Excel.Worksheet In xlSheets
                    Try
                        If wsh.Name.Equals(ComConst.集計結果表作成論理.出力用ファイル名称.SheetName) Then
                            bln = True
                            Exit For
                        End If
                    Finally
