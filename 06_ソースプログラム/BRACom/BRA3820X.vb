...
'//*************************************************************************************************
''' <summary>
''' 個別結果表審査論理入力・修正（範囲）（EXCEL）
''' </summary>
''' <remarks></remarks>

Public Class BRA3820X
    ...
    Private Const HEADER_TITLE As String = "個別結果表審査論理入力・修正（範囲）画面"
    ...
    ' REV_001↑
    ''' <summary>個別結果表審査論理管理（範囲）画面</summary>
    Private _Form As BRA3810F
    ...
    'Public Sub New(ByRef frm As BRA3810F)
    Public Sub New(ByRef frm As BRA3810F, versionKbn As String)
        ' REV_001↑
        MyBase.New(frm, System.IO.Path.Combine(IniFileInfo.ExcelReportPath(), ComConst.個別結果表審査論理範囲.入力用ファイル名称), True)
        Try
            _Form = frm
