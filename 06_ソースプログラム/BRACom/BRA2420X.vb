...
''' <summary>
''' 調査票審査論理入力・修正（範囲）（EXCEL）
''' </summary>
''' <remarks></remarks>

Public Class BRA2420X
    ...
    Private Const HEADER_TITLE As String = "調査票審査論理入力・修正（範囲）画面"
    ...
    ''' <summary>調査票審査論理管理（範囲）画面</summary>
    Private _Form As BRA2410F
    ...
    ''' <remarks></remarks>
    Public Sub New(ByRef frm As BRA2410F)
        MyBase.New(frm, System.IO.Path.Combine(IniFileInfo.ExcelReportPath(), ComConst.調査票審査論理範囲.入力用ファイル名称), True)
        Try
            _Form = frm
